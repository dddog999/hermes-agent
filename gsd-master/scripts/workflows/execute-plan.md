...
Read: /home/dddog/.hermes/skills/gsd-master/references/git-integration.md
</required_reading>
...
```bash
NODE_REPAIR=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" config-get workflow.node_repair 2>/dev/null || echo "true")
```

If `NODE_REPAIR` is `true`: invoke `@./.agents/skills/gsd-master/scripts/workflows/node-repair.md` with:
