...
```bash
PHASE_INFO=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
