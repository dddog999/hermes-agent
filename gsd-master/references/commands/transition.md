---
name: transition
description: GSD transition workflow
---
<internal_workflow>
...
```bash
TRANSITION=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
