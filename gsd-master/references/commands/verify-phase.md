---
name: verify-phase
description: GSD verify phase workflow
---
<purpose>
...
<required_reading>
Read: /home/dddog/.hermes/skills/gsd-master/references/docs/verification-patterns.md
Read: /home/dddog/.hermes/skills/gsd-master/references/templates/verification-report.md
</required_reading>
...
```bash
INIT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" init phase-op "${PHASE_ARG}")
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" roadmap get-phase "${phase_number}"
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" frontmatter get "$plan" --field must_haves)
...
```bash
PHASE_DATA=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" roadmap get-phase "${phase_number}" --raw)
```
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" verify key-links "$plan")
...
See /home/dddog/.hermes/skills/gsd-master/templates/verification-report.md for complete template.
</step>
