---
name: resume-project
description: GSD resume project workflow
---
<trigger>
...
<required_reading>
Read: /home/dddog/.hermes/skills/gsd-master/references/docs/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" init resume)
