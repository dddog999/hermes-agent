---
name: execute-plan
description: GSD execute plan workflow
---
<purpose>
...
Read: /home/dddog/.hermes/skills/gsd-master/references/docs/git-integration.md
</required_reading>
...
```bash
INIT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" init execute-phase "${PHASE}")
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" phases list --type summaries --raw
...
See `/home/dddog/.hermes/skills/gsd-master/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /home/dddog/.hermes/skills/gsd-master/references/checkpoints.md for details.
</step>
...
```bash
NODE_REPAIR=$(node "./.agents/skills/gsd-master/scripts/gsd-tools.cjs" config-get workflow.node_repair 2>/dev/null || echo "true")
```

If `NODE_REPAIR` is `true`: invoke `See: /home/dddog/.hermes/skills/gsd-master/scripts/workflows/node-repair.md` with:
...
If user_setup exists: create `{phase}-USER-SETUP.md` using template `/home/dddog/.hermes/skills/gsd-master/templates/user-setup.md`. Per service: env vars table, account setup checklist, dashboard config, local dev notes, verification commands. Status "Incomplete". Set `USER_SETUP_CREATED=true`. If empty/missing: skip.
</step>

<step name="create_summary">
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/home/dddog/.hermes/skills/gsd-master/templates/summary.md`.
...
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" state advance-plan

# Recalculate progress bar from disk state
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" state update-progress

# Record execution metrics
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" state record-metric \
...
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" state add-decision \
  --phase "${PHASE}" --summary-file "${DECISION_TEXT_FILE}" --rationale-file "${RATIONALE_FILE}"

# Add blockers if any found
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" state add-blocker --text-file "${BLOCKER_TEXT_FILE}"
```
</step>
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" state record-session \
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" roadmap update-plan-progress "${PHASE}"
```
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" requirements mark-complete ${REQ_IDS}
```
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "docs({phase}-{plan}): complete [plan-name] plan" --files .planning/phases/XX-name/{phase}-{plan}-SUMMARY.md .planning/STATE.md .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
</step>
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "" --files .planning/codebase/*.md --amend
```
</step>
