---
name: map-codebase
description: GSD map codebase workflow
---
<purpose>
...
```bash
INIT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" init map-codebase)
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
