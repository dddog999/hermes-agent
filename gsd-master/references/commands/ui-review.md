---
name: ui-review
description: GSD ui review workflow
---
<purpose>
...
```bash
UI_AUDITOR_MODEL=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" resolve-model gsd-ui-auditor --raw)
```
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
