---
name: profile-user
description: GSD profile user workflow
---
<purpose>
...
Key references:
- @/home/dddog/.hermes/skills/gsd-master/references/ui-brand.md (display patterns)
- @/home/dddog/.hermes/skills/gsd-master/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/dddog/.hermes/skills/gsd-master/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=/home/dddog/.hermes/skills/gsd-master/USER-PROFILE.md"
...
```bash
cp /home/dddog/.hermes/skills/gsd-master/USER-PROFILE.md" /home/dddog/.hermes/skills/gsd-master/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/dddog/.hermes/skills/gsd-master/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/home/dddog/.hermes/skills/gsd-master/references/user-profiling.md`
...
Reference: @/home/dddog/.hermes/skills/gsd-master/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /home/dddog/.hermes/skills/gsd-master/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to $HOME/.codebuddy/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/dddog/.hermes/skills/gsd-master/USER-PROFILE.md" and jump to step 10.
...
```bash
node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd-dev-preferences at $HOME/.codebuddy/commands/gsd/dev-preferences.md"

**For CLAUDE.md profile section (if selected):**

```bash
node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to $HOME/.codebuddy/CLAUDE.md"
...
```bash
BACKUP_PATH=/home/dddog/.hermes/skills/gsd-master/USER-PROFILE.backup.md"
```
...
Your profile:    /home/dddog/.hermes/skills/gsd-master/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/.codebuddy/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        $HOME/.codebuddy/CLAUDE.md
```
