---
name: check-todos
description: GSD check todos workflow
---
<purpose>
...
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "docs: start work on todo - [title]" --files .planning/todos/done/[filename] .planning/STATE.md
```
