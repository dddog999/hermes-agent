---
name: quick
description: GSD quick workflow
---
<purpose>
...
```bash
INIT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
