---
name: health
description: GSD health workflow
---
<purpose>
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" validate health
```
