---
name: plant-seed
description: GSD plant seed workflow
---
<purpose>
...
```bash
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
