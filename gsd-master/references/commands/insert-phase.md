---
name: insert-phase
description: GSD insert phase workflow
---
<purpose>
...
```bash
INIT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
