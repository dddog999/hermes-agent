---
name: validate-phase
description: GSD validate phase workflow
---
<purpose>
...
```bash
AUDITOR_MODEL=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" resolve-model gsd-nyquist-auditor --raw)
NYQUIST_CFG=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" config get workflow.nyquist_validation --raw)
```
...
**State B (create):**
1. Read template from `/home/dddog/.hermes/skills/gsd-master/templates/VALIDATION.md`
...
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
