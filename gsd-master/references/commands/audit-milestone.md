...
description: GSD audit milestone workflow
---
<purpose>
...
```bash
INIT=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" init milestone-op)
...
```bash
integration_checker_model=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" resolve-model gsd-integration-checker --raw)
```
...
node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" phases list
```
...
PHASE_INFO=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" find-phase 01 --raw)
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" summary-extract "$summary" --fields requirements_completed | jq -r '.requirements_completed'
done
```
...
```bash
NYQUIST_CONFIG=$(node "/home/dddog/.hermes/skills/gsd-master/scripts/gsd-tools.cjs" config get workflow.nyquist_validation --raw 2>/dev/null)
```
