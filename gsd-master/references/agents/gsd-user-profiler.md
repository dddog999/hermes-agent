...
**How to spawn:**
```
agent_file = read_file("references/agents/gsd-user-profiler.md")
delegate_task(
  goal="Analyze developer session messages across 8 behavioral dimensions. Produce scored profile.",
...
**Expected output:** Scored developer profile with confidence levels and behavioral evidence.
...
<reference>
@gsd-master/references/user-profiling.md
...
Read the user-profiling reference document at `gsd-master/references/user-profiling.md` to load:
