...
**How to spawn:**
```
agent_file = read_file("references/agents/gsd-ui-auditor.md")
delegate_task(
  goal="Retroactive 6-pillar visual audit of implemented frontend code. Produce scored UI-REVIEW.md.",
  context=f"{agent_file}\n\nProject paths: {phase_dir}, UI source files"
)
```

**Available tools:** Read, Write, Bash, Grep, Glob

**Expected output:** Scored UI-REVIEW.md against 6 quality dimensions.
