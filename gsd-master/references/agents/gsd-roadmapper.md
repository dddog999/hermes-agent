...
**How to spawn:**
```
agent_file = read_file("references/agents/gsd-roadmapper.md")
delegate_task(
  goal="Create project roadmap with phase breakdown, requirement mapping, success criteria.",
  context=f"{agent_file}\n\nProject paths: .planning/research/, .planning/PROJECT.md, .planning/REQUIREMENTS.md"
)
```

**Available tools:** Read, Write, Bash, Glob, Grep

**Expected output:** ROADMAP.md with phases, milestones, requirements mapping, success criteria.
...
Reference full template: `~/skills/gsd-master/templates/roadmap.md`

## STATE.md Structure

Use template from `~/skills/gsd-master/templates/state.md`.
