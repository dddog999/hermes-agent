...
- Usage: Reference from command with `@/home/dddog/.hermes/skills/gsd-master/scripts/workflows/{name}.md`

**New Reference Document:**
- Implementation: `gsd-master/references/{name}.md`
