...
```bash
PHASE_INFO=$(node "$HOME/.agents/skills/gsd-master/scripts/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "$HOME/.agents/skills/gsd-master/scripts/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "$HOME/.agents/skills/gsd-master/scripts/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
