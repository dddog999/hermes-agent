...
See $HOME/.agents/skills/gsd-master/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.agents/skills/gsd-master/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.agents/skills/gsd-master/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.agents/skills/gsd-master/templates/discovery.md
...
Use $HOME/.agents/skills/gsd-master/templates/discovery.md.
