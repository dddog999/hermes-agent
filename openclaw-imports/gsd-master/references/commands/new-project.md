...
```bash
INIT=$(node "@../scripts/gsd-tools.cjs" init new-project)
...
```bash
mkdir -p .planning
node "@../scripts/gsd-tools.cjs" commit "chore: add project config" --files .planning/config.json
```

**Persist auto-advance chain flag to config (survives context compaction):**

```bash
node "@../scripts/gsd-tools.cjs" config-set workflow._auto_chain_active true
```
...
```bash
mkdir -p .planning
node "@../scripts/gsd-tools.cjs" commit "docs: initialize project" --files .planning/PROJECT.md
```
...
Use template: $HOME/.agents/skills/gsd-master/templates/research-project/STACK.md
</output>
...
Use template: $HOME/.agents/skills/gsd-master/templates/research-project/FEATURES.md
</output>
...
Use template: $HOME/.agents/skills/gsd-master/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: $HOME/.agents/skills/gsd-master/templates/research-project/PITFALLS.md
</output>
...
Use template: $HOME/.agents/skills/gsd-master/templates/research-project/SUMMARY.md
...
```bash
node "@../scripts/gsd-tools.cjs" commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node "@../scripts/gsd-tools.cjs" commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
