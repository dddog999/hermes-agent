...
```bash
INIT=$(node "@../scripts/gsd-tools.cjs" init progress)
...
- `STATE=$(node "@../scripts/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "@../scripts/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "@../scripts/gsd-tools.cjs" progress bar --raw)
```
