...
PHASES=$(node "@../scripts/gsd-tools.cjs" phases list)
...
```bash
node "@../scripts/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
