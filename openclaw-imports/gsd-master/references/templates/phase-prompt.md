...
<execution_context>
@$HOME/.agents/skills/gsd-master/scripts/workflows/execute-plan.md
@$HOME/.agents/skills/gsd-master/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@$HOME/.agents/skills/gsd-master/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @$HOME/.agents/skills/gsd-master/references/checkpoints.md -->
...
See `$HOME/.agents/skills/gsd-master/references/tdd.md` for TDD plan structure.
...
See `$HOME/.agents/skills/gsd-master/templates/user-setup.md` for full schema and examples
...
See `$HOME/.agents/skills/gsd-master/scripts/workflows/verify-phase.md` for verification logic.
