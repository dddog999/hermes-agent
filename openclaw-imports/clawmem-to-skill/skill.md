---
name: clawmem-to-skill
description: Use when user requests to extract experience as skill, generate skill, sync skill to global, or when high-salience memories (>0.8) need to be solidified into reusable skills or rules.
context: inline
