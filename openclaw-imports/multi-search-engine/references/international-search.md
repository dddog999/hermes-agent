...
| **密码生成** | `password` | `https://html.duckduckgo.com/html/?q=password+20` |
| **颜色转换** | `color` | `https://html.duckduckgo.com/html/?q=+%23FF5733` |
| **短链接** | `shorten` | `https://html.duckduckgo.com/html/?q=shorten+example.com` |
| **二维码生成** | `qr` | `https://html.duckduckgo.com/html/?q=qr+hello+world` |
| **生成UUID** | `uuid` | `https://html.duckduckgo.com/html/?q=uuid` |
| **Base64编解码** | `base64` | `https://html.duckduckgo.com/html/?q=base64+hello` |
...
| 参数 | 功能 | 示例 |
|------|------|------|
| `kp=1` | 严格安全搜索 | `https://html.duckduckgo.com/html/?q=test&kp=1` |
| `kp=-1` | 关闭安全搜索 | `https://html.duckduckgo.com/html/?q=test&kp=-1` |
| `kl=cn` | 中国区域 | `https://html.duckduckgo.com/html/?q=news&kl=cn` |
| `kl=us-en` | 美国英文 | `https://html.duckduckgo.com/html/?q=news&kl=us-en` |
| `ia=web` | 网页结果 | `https://html.duckduckgo.com/html/?q=test&ia=web` |
| `ia=images` | 图片结果 | `https://html.duckduckgo.com/html/?q=test&ia=images` |
| `ia=news` | 新闻结果 | `https://html.duckduckgo.com/html/?q=test&ia=news` |
| `ia=videos` | 视频结果 | `https://html.duckduckgo.com/html/?q=test&ia=videos` |

### 2.4 DuckDuckGo 深度搜索示例

```javascript
// 1. 使用Bang跳转到Google搜索
web_fetch({"url": "https://html.duckduckgo.com/html/?q=!g+machine+learning"})

// 2. 直接搜索GitHub上的项目
web_fetch({"url": "https://html.duckduckgo.com/html/?q=!gh+react"})

// 3. 查找Stack Overflow答案
web_fetch({"url": "https://html.duckduckgo.com/html/?q=!so+python+list+comprehension"})

// 4. 生成密码
web_fetch({"url": "https://html.duckduckgo.com/html/?q=password+16"})

// 5. Base64编码
web_fetch({"url": "https://html.duckduckgo.com/html/?q=base64+hello+world"})

// 6. 颜色代码转换
web_fetch({"url": "https://html.duckduckgo.com/html/?q=%23FF5733"})

// 7. 搜索YouTube视频
web_fetch({"url": "https://html.duckduckgo.com/html/?q=!yt+python+tutorial"})

// 8. 查看Wikipedia
web_fetch({"url": "https://html.duckduckgo.com/html/?q=!w+artificial+intelligence"})

// 9. 亚马逊商品搜索
web_fetch({"url": "https://html.duckduckgo.com/html/?q=!a+laptop"})

// 10. 生成二维码
web_fetch({"url": "https://html.duckduckgo.com/html/?q=qr+https://github.com"})
```
